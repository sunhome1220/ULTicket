...
<body>
	...
	<form name="loginForm" method="post" action="">
		...
		<table width="100%" cellspacing="3" cellpadding="4" border="1"
			rules="all">
			<tr><td class="labelField">處理單位：</td>
                            <td class="dataField">
                                <select class="selectpicker" data-width="100px" id="TM_PR_D_UNIT_CD" name="unitLevel2"></select> 
                                <select class="selectpicker" data-width="100px" id="TM_PR_B_UNIT_CD" name="unitLevel3"></select> 
                                <select class="selectpicker" data-width="100px" id="TM_PR_UNIT_CD" name="unitLevel4"></select>
                            </td>
			</tr>
                        <tr><td class="labelField">登入帳號：</td>
                            <td class="dataField">
                                <input type="text" class="form-control" id="TM_USER_ID" name="TM_USER_ID" placeholder="八碼英數字" value="ABCD0001" maxlength="8"/>
                            </td>
			</tr>
                        <tr><td class="labelField">登入姓名：</td>
                            <td class="dataField">
                                <input type="text" class="form-control" id="TM_USER_NM" name="TM_USER_NM" placeholder="" value="中山分局測試"/>
                            </td>
			</tr>
                        ...
                        <td colspan="2">
                            <fieldset><legend>角色</legend>
                                <table width="100%" style="font-size:9pt" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="roles" value="CJ000006" title="CJ000006"/>CJ000006-署資訊室業務承辦人<br/>                                         
                                            <input type="checkbox" name="roles" value="CJ000005" title="CJ000005"/>CJ000005-刑事局業務承辦人<br/>                                         
                                            <input type="checkbox" name="roles" value="CJ000004" title="CJ000004"/>CJ000004-刑事局鑑識人員<br/>                                         
                                            <input type="checkbox" name="roles" value="CJ000003" title="CJ000003"/>CJ000003-警局業務承辦人<br/>
                                            <input type="checkbox" name="roles" value="CJ000002" title="CJ000002"/>CJ000002-縣市鑑識人員<br/>
                                            <input type="checkbox" name="roles" value="CJ000001" title="CJ000001"/>CJ000001-一般使用者<br/>                                         
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                ...
                <table width="100%" cellspacing="3" cellpadding="4" border="1"
                           rules="all">
			<tr>
				<td nowrap="nowrap"><b><font color="red">署系統管理人員</font></b></td>
				<td>
                                    <input type="button" name="" value="署資訊室業務承辦人" 	onclick="login('ABCD6001')" title="ABCD6001" />                                                                        
                                </td>
			</tr>
                        <tr>
				<td nowrap="nowrap"><b><font color="red">刑事局人員</font></b></td>
				<td>
                                    <input type="button" name="" value="刑事局業務承辦人" onclick="login('ABCD5001')" title="ABCD5001" />
                                    <input type="button" name="" value="刑事局鑑識科" onclick="login('ABCD4001')" title="ABCD4001" />
                                </td>
			</tr>
                        <tr>
                            <td nowrap="nowrap" rowspan="1"><b><font color="red">警局人員</font></b></td>
				<td>
                                    <input type="button" name="" value="北市刑大偵查組" onclick="login('ABCD3001')"  title="ABCD3001"/>
                                    <input type="button" name="" value="新北刑大偵查組" onclick="login('ABCD3002')"  title="ABCD3002"/>                                    
                                </td>
                            </td>
			</tr>                        
                        <tr>
                            <td nowrap="nowrap" rowspan="1"><b><font color="red">警局鑑識人員</font></b></td>
				<td>
                                    <input type="button" name="" value="北市警局鑑識人員" onclick="login('ABCD2001')"  title="ABCD2001"/>                                    
                                    <input type="button" name="" value="新北警局鑑識人員" onclick="login('ABCD2002')"  title="ABCD2002"/>
                                </td>
                            </td>
			</tr>                        
                        <tr>
				<td nowrap="nowrap"><b><font color="red">分局人員</font></b></td>
				<td>
                                    <input type="button" name="" value="北市中山分局偵查隊" onclick="login('ABCD1001')"  title="ABCD1001"/>                                    
                                    <input type="button" name="" value="北市大安分局偵查組" onclick="login('ABCD1002')"  title="ABCD1002"/>                                    
                                    <input type="button" name="" value="新北板橋分局偵查組" onclick="login('ABCD1003')"  title="ABCD1003"/>                                    
                                </td>
			</tr>                        
		</table>
	</form>
